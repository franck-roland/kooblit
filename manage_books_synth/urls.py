...
urlpatterns = patterns('',
                       ...
                       url(r'^(?P<book_title>.{1,' + str(settings.MAX_BOOK_TITLE_LEN) + '})/(?P<search_title>.{1,' + str(settings.MAX_BOOK_TITLE_LEN) + '})/search/$', 'manage_books_synth.views.book_search', name='search'),
